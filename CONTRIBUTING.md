# Contributing to tdfextractor

Bug reports, fixes and new features are welcome. Use the
[issue tracker](https://github.com/tacular-omics/tdfextractor/issues) for bugs and
questions, with a minimal example and the tdfextractor and Python versions. Report
...
```bash
git clone https://github.com/tacular-omics/tdfextractor.git
cd tdfextractor
just install
```
